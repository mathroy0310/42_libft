...
void	diuxx_processor(t_printable *prtbl, va_list args, char **to_print)
{
	long	value;
...
t_bool	convert_zeros_and_check_precision(t_printable *prtbl, char **to_print,
		long value)
{
...
void	fill_zeros(t_printable *prtbl, char **to_print, long value)
{
	int	zeros;
